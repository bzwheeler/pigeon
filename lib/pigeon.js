...
_.extend(Pigeon.prototype, {
    ...
    connect : function(options) {
        ...
        return this.connectionQ.promise;
    },
            ...
            self._getQueue(type, function(err, queue) {
                ...
                queue.subscribe(options, handler)
                    .addCallback(function(ok) {
                        self.subscriptions[ok.consumerTag] = queue;
                        q.resolve(ok.consumerTag);
                    });
            });
        });
    ...
    unsubscribe : function(subscriptionKey) {
        ...
        if (this.subscriptions[subscriptionKey]) {
            ...
            q.reject(new Error('Could not find a consumerTag matching ' + subscriptionKey));
        }
